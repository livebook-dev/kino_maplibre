              ...
              <template v-slot:content>
                ...
                <div class="row">
                  ...
                  <div class="field range-wrapper" v-if="layer.layer_type === 'heatmap'">
                    <span class="rangeValue">{{ layerRadius(index) }}</span>
                    <BaseInput
                      name="layer_radius"
                      :index="index"
                      type="range"
                  ...
                  <div class="row row--group" v-if="layer.layer_type === 'cluster'">
                    <BaseInput
                      name="cluster_min"
                      label="Min"
                      :index="index"
                    ...
                    />
                    <BaseInput
                      name="cluster_color_1"
                      label="Color 1"
                      :index="index"
                      type="color"
                      v-model="layer.cluster_color_1"
                      :disabled="noSourceVariable"
                      :required
                      class="color-field"
                    />
                    <BaseInput
                      name="cluster_color_2"
                      label="Color 2"
                      :index="index"
                      type="color"
                      v-model="layer.cluster_color_2"
                      :disabled="noSourceVariable"
                      :required
                      class="color-field"
                    />
                    <BaseInput
                      name="cluster_color_3"
                      label="Color 3"
                      :index="index"
                      type="color"
                      v-model="layer.cluster_color_3"
                      :disabled="noSourceVariable"
                      :required
                      class="color-field"
                    />
