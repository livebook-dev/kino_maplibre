    ...
    template: `
      <div class="app">
        ...
        <div class="container">
          <div class="root">
            <BaseSelect
              ...
              <BaseInput
                ...
                class="input--sm range"
                :min="0"
                :max="24"
              />
          </div>
          <div class="sources">
            <Accordion v-for="(source, index) in sources" @remove-layer="removeSource(index)" :showDelete="hasSources">
          ...
          <div class="layers">
            <Accordion v-for="(layer, index) in layers" @remove-layer="removeLayer(index)" :showDelete="hasLayers">
              <template v-slot:title>
                <span>
