  ...
  const app = Vue.createApp({
          ...
          <div class="layers">
            ...
            >
              ...
              <template v-slot:content>
                ...
                <div v-if="layer.layer_source_type === 'table'" class="row">
                  <BaseSelect
                    v-if="layer.coordinates_type === 'combined'"
                    name="layer_lng_lat"
                    label="Coordinates column (combined)"
                    :index="index"
                    v-model="layer.layer_lng_lat"
                    :options="sourceOptions(layer)"
                    :required
                  />
                  <BaseSelect
                    v-if="layer.coordinates_type === 'columns'"
                    name="layer_longitude"
                    label="Longitude column (lng)"
                    :index="index"
                    v-model="layer.layer_longitude"
                    :options="sourceOptions(layer)"
                    :required
                  />
                  <BaseSelect
                  ...
                  <div class="radio-group">
                    <BaseRadioGroup
                      ...
                      :name="'coordinates_format_' + index"
                  ...
                  <div class="radio-group">
                    <BaseRadioGroup
                      v-model="layer.coordinates_type"
                      :name="'coordinates_type_' + index"
    ...
    data() {
      return {
        ...
        coordinateOptions: [
          { label: "Longitude, Latitude", value: "lng-lat" },
          { label: "Latitude, Longitude", value: "lat-lng" },
        ],
      };
    },
