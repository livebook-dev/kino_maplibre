  ...
  const app = Vue.createApp({
    ...
    data() {
      return {
        ...
        coordinateLabels: ["Two columns", "Single: lng, lat", "Single: lat, lng"],
        coordinateOptions: ["columns", "lng_lat", "lat_lng"],
      };
    },
    ...
    methods: {
      ...
      handleFieldChange(event) {
        ...
        name && updateField(idx, name, value);
      },
        ...
        template: `
          <div class="field">
            ...
            >
              ...
              <option
                v-for="pair in zip(labels || options, options)"
                :value="pair.value"
                :selected="pair.value === modelValue"
              >{{ pair.key }}</option>
              <option
