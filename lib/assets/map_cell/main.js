...
export function init(ctx, payload) {
  ...
  const Accordion = {
    ...
    template: `
        <div class="layer-wrapper" :class="{'accordion-open': hasLayers || (!isOpen && !hasLayers)}">
          <div
  ...
  const app = Vue.createApp({
    components: { BaseSelect, BaseInput, Accordion, FieldGroup },
    template: `
      <div class="app">
        <!-- Info Messages -->
